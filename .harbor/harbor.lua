...
bootVFS = function(hvfs)
    ...
    --[[READABLE FORMAT of startup.lua
        ...
        os.loadAPI('/.harbor/harbor.lua') -- Load up harbor for a moment
        local out = harbor.mountString(hvfs) -- Mount the VFS
        os.unloadAPI('/.harbor/harbor.lua') -- Begone Harbor!
        ...
        fs.move('/.harbor/startup.lua', '/startup.lua') -- Move your oh so precious startup back to its rightful position, overwriting this file
